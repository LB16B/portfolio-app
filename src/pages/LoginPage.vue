<template>
    <main class="w-2/5 mx-auto mt-20">
        <form class=" bg-red-50 p-8 w-3/4 mx-auto" @submit.prevent="handleSubmit">
            ...
            <button class="w-1/3 mx-auto items-center flex pl-10 mt-12 mb-6  bg-pink-500 rounded h-12 text-white text-xl hover:bg-pink-600" type="submit">ログインする</button>
        </form>
    </main>
</template>
